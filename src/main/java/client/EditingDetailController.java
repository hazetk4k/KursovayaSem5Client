...
public class EditingDetailController extends BaseController implements Initializable {
    ...
    public void onBtnSubmit(ActionEvent actionEvent) throws IOException {
        if (Objects.equals(name.getText(), "") || Objects.equals(text1.getText(), "") || Objects.equals(text2.getText(), "") || Objects.equals(mileage.getText(), "") || Objects.equals(price.getText(), "")) {
            ...
            out.println("Изменить деталь; " + table + "; " + name.getText() + "; " + text1.getText() + "; " + text2.getText() + "; " + mileage.getText() + "; " + price.getText() + "; " + BaseController.chosenName);
            line = in.readLine();
            if (Objects.equals(line, "changed")) {
                name.setText("");
                text1.setText("");
                text2.setText("");
                mileage.setText("");
                price.setText("");
                name.setPromptText("Запись изменена!");
                ...
                mileage.setText("");
                price.setText("");
                name.setPromptText("Запись используется!");
                btnSubmit.setDisable(true);
            }
        }
    }
